...
const GoogleLoginButton = ({ onSuccess, onError, label = 'Continue with Google' }) => {
    if (!GCID) return null;

    return <GoogleButtonInner onSuccess={onSuccess} onError={onError} label={label} />;
};

const GoogleButtonInner = ({ onSuccess, onError, label }) => {
